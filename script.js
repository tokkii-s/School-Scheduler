...
document.addEventListener('DOMContentLoaded', () => {
  console.log('School Scheduler: Initializing...');
  try {
    loadState();
    initTabs();
    initAddForms();
    ...
    refreshTab('home');
    initInfiniteScroll();
    console.log('School Scheduler: Initialization complete.');
  } catch (error) {
    console.error('School Scheduler: Initialization failed!', error);
  }
});
